...
import { useEventDetailsRef } from "../../hooks/useEventDetailsRef";
...
export default function InfoEventsCard({ event, title = "יירוט", onClose }: InfoEventsCardProps) {
  ...
  const [eventDetailsHTML, setEventDetailsHTML] = useState<string | null>(null);
  const ref = useEventDetailsRef(setEventDetailsHTML, [event]);
